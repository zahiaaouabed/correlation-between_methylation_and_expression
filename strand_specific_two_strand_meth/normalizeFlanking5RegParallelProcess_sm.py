...
def readProfile(i, profile, achr, tss, tts, bin_size, nb_partition) :
    ...
    output_filename = "5met/"+tcontext+"/s"+str(i)+".met_chr"+achr+"_"+str(tss)+"_"+str(tts)+".gene."+tcontext+".5.flanking.met"
        ...
        for row in spamreader:
            if (len(row) >= 8) :
                ...
                for x in range(0, nb_partition):
                    ...
                    if ((position < tts - x * bin_size) and (position >= tts - (x+1) * bin_size)) :
